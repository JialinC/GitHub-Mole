import re
from backend.app.services.github_query.queries.repositories.repository_contributors_contribution import (
...
class TestRepositoryContributorsContributionInit:
    def test_repository_contributors_contribution_query_structure(self):
        ...
        repository_contributors_contribution_query = (
            RepositoryContributorsContribution()
        )
        ...
        ), "The RepositoryContributorsContribution query does not match the expected structure."
    ...
    def test_user_cumulated_contribution(self):
        ...
        cumulative_contribution = (
            RepositoryContributorsContribution.user_cumulated_contribution(raw_data)
        )
        assert (
            cumulative_contribution == expected_cumulative_contribution
        ), "The cumulated contributions do not match the expected structure."
    ...
    def test_user_commit_contribution(self):
        ...
        commit_contributions = (
            RepositoryContributorsContribution.user_commit_contribution(raw_data)
        )
        assert (
            commit_contributions == expected_commit_contributions
        ), "The individual commit contributions do not match the expected structure."
